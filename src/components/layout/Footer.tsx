...
async function getSocialLinks() {
  try {
    ...
    const res = await fetch(`${base}/api/config/social`, { next: { revalidate: 3600 } });
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div>
            ...
            <div className="flex gap-3">
              <a href={social.social_facebook || "https://facebook.com"} target="_blank" rel="noopener noreferrer"
              ...
              <a href={social.social_instagram || "https://instagram.com"} target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-zinc-200 flex items-center justify-center hover:bg-black hover:text-white transition-all">
              ...
              <a href={social.social_youtube || "https://youtube.com"} target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-zinc-200 flex items-center justify-center hover:bg-black hover:text-white transition-all">
              ...
              <a href={social.social_tiktok || "https://tiktok.com"} target="_blank" rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-zinc-200 flex items-center justify-center hover:bg-black hover:text-white transition-all">
