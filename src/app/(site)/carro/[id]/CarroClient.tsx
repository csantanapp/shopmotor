        ...
        <div className="lg:col-span-4">
            ...
            {vehicle.user.subPlan === "ELITE" && vehicle.user.storeSlug && (
              <>
                <div className="bg-surface-container-low rounded-2xl p-4 flex items-center gap-4">
                  <div className="w-10 h-10 bg-primary-container/30 rounded-xl flex items-center justify-center flex-shrink-0">
                    <Icon name="account_balance" className="text-on-surface text-xl" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-on-surface text-sm font-black leading-tight">Financie este veículo</p>
                    <p className="text-on-surface-variant text-xs mt-0.5">Simule em segundos · sem consulta ao SPC · aprovação em 24h</p>
                  </div>
                  <Link
                    href={`/financiamento?loja=${vehicle.user.storeSlug}&veiculo=${vehicle.id}`}
                    className="bg-primary-container text-on-primary-container font-black px-4 py-2.5 rounded-xl text-sm whitespace-nowrap hover:opacity-90 transition-opacity flex-shrink-0"
                  >
                    SIMULAR
                  </Link>
                </div>
          ...
          <div className="bg-surface-container-lowest rounded-2xl p-6 shadow-sm space-y-5">
            ...
            <div className="space-y-2 text-xs text-on-surface-variant divide-y divide-surface-container">
              ...
              <div className="flex items-center justify-between py-1.5">
                <span className="font-medium">Anúncios realizados na ShopMotor</span>
