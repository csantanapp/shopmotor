...
const PLANS: {
...
}[] = [
  {
    ...
    features: [
      { text: "No topo da busca durante 5 dias" },
      { text: "5 dias com selo Destaque" },
      { text: "3 dias na galeria Destaque" },
      { text: "Borda amarela nos resultados de busca" },
      { text: "Selo 'Destaque' no card do anúncio" },
  ...
  },
  {
    ...
    features: [
      { text: "No topo da busca durante 7 dias", strong: true },
      { text: "7 dias com selo Destaque", strong: true },
      { text: "5 dias na galeria Destaque" },
      { text: "Borda amarela nos resultados de busca" },
      { text: "Selo 'Destaque' no card do anúncio" },
      { text: "Posição privilegiada na seção Destaques da Home" },
      { text: "Maior visibilidade para compradores" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "15 dias com selo Super Destaque", strong: true },
      { text: "15 dias na galeria Destaque", strong: true },
      { text: "15 dias anúncio patrocinado", strong: true },
      { text: "Borda exclusiva nos resultados de busca" },
      { text: "Selo 'Super Destaque' no card do anúncio" },
      { text: "Destaque máximo na seção Elite da Home" },
